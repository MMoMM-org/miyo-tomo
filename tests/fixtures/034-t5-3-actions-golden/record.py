#!/usr/bin/env python3
# version: 1.0.0
"""Record the spec-034 T5.3 no-clash action-list baseline.
...
Run from the repo root:  ./venv/bin/python tests/fixtures/034-t5-3-actions-golden/record.py

This exists so the baseline can be re-derived and its provenance checked. It is
NOT run by the suite: the fixture it produced was committed before the T5.3

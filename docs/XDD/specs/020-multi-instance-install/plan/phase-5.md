...
- [x] **T5.1 Document multi-instance install + registry + update-check** `[activity: documentation]`
...
- [x] **T5.2 Remove lifecycle-tag references from docs + example config** `[activity: documentation]` `[parallel: true]`
...
- [x] **T5.3 Final validation + version-bump audit** `[activity: validate]`
...
- [ ] **T5.4 Two-instance live smoke (operator)** `[activity: validate]` — ⏳ OPERATOR-PENDING (Marcus runs; Docker + real two-instance creation)
...
- [x] **T5.5 Spec close-out** `[activity: validate]`

...
- `docs/XDD/reference/tier-2/components/template-system.md` — Template rendering pipeline, token syntax
- `docs/XDD/reference/tier-2/components/user-config.md` — vault-config.yaml full schema
- `docs/XDD/reference/tier-3/templates/template-files.md` — Template definitions (sections 4.1-4.5)
- `docs/XDD/reference/tier-3/config/frontmatter-schema.md` — Frontmatter schema
...
- [ ] **T2.1 Atomic Note Template** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read template spec section 4.1 `[ref: docs/XDD/reference/tier-3/templates/template-files.md §4.1]` and MiYo frontmatter defaults `[ref: docs/XDD/reference/tier-3/profiles/miyo-profile.md]`
...
- [ ] **T2.2 Map Note (MOC) Template** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read template spec section 4.2 `[ref: docs/XDD/reference/tier-3/templates/template-files.md §4.2]`
...
- [ ] **T2.3 Daily Note Template** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read template spec section 4.3 `[ref: docs/XDD/reference/tier-3/templates/template-files.md §4.3]`
...
- [ ] **T2.4 Project + Source Templates** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read template spec sections 4.4 and 4.5 `[ref: docs/XDD/reference/tier-3/templates/template-files.md §4.4-4.5]`
...
- [ ] **T2.5 Vault Config Example Update** `[activity: data-architecture]`
  ...
  1. Prime: Read user config schema `[ref: docs/XDD/reference/tier-2/components/user-config.md]` and frontmatter schema `[ref: docs/XDD/reference/tier-3/config/frontmatter-schema.md]`

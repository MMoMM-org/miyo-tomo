...
- [x] **T3.1 `inbox-discovery.py` — unified discovery + bucketing + drift detection** `[activity: backend-implementation]`
...
- [x] **T3.2 `state-promoter.py` — flip_state + tick detection helper** `[activity: backend-implementation]`
...
- [x] **T3.3 `inbox-orchestrator.md` Phase A rewrite (A2.5b/c/d/e) + A4 removal** `[activity: agent-prompt-update]`
...
- [x] **T3.4 Remove `state-init.py` legacy paths (or shrink to listDir helper)** `[activity: refactor]`

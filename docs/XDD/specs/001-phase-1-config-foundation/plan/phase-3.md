...
- `docs/XDD/reference/tier-3/wizard/install-script.md` — Full install script spec (10-step flow)
- `docs/XDD/reference/tier-3/config/frontmatter-schema.md` §1 — yaml-fixer spec
...
- [ ] **T3.1 Install Script — Profile Selection + Concept Mapping** `[activity: build-feature]`
  ...
  1. Prime: Read install script spec `[ref: docs/XDD/reference/tier-3/wizard/install-script.md]` and existing `scripts/install-tomo.sh`
...
- [ ] **T3.2 Install Script — Config Generation + Non-Interactive Mode** `[activity: build-feature]`
  ...
  1. Prime: Read vault-config schema `[ref: docs/XDD/reference/tier-2/components/user-config.md]` and install script spec step 7 `[ref: docs/XDD/reference/tier-3/wizard/install-script.md]`
...
- [ ] **T3.3 YAML Fixer Utility** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read frontmatter schema spec §1 `[ref: docs/XDD/reference/tier-3/config/frontmatter-schema.md §1]`

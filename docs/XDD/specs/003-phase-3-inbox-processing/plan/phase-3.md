...
- `docs/XDD/reference/tier-2/workflows/inbox-processing.md` — workflow orchestration
- `docs/XDD/reference/tier-3/inbox/state-tag-lifecycle.md` — run-to-run discovery
- `docs/XDD/reference/tier-3/templates/token-vocabulary.md` — token system knowledge
...
- [ ] **T3.1 Inbox Command** `[activity: build-feature]`
  ...
  1. Prime: Read existing `tomo/.claude/commands/inbox.md` and `[ref: docs/XDD/reference/tier-2/workflows/inbox-processing.md]`
...
- [ ] **T3.2 PKM Workflows Skill** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/inbox/state-tag-lifecycle.md]` and `[ref: docs/XDD/reference/tier-3/inbox/inbox-analysis.md]`
...
- [ ] **T3.3 Template Render Skill** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/templates/token-vocabulary.md]` and `[ref: docs/XDD/reference/tier-2/components/template-system.md]`

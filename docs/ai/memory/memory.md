...
## Files
- [general.md](general.md) — conventions, style, naming [updated: 2026-05-22]
- [tools.md](tools.md) — CI, build, local dev [updated: 2026-05-08]
- [domain.md](domain.md) — business rules, data models [updated: YYYY-MM-DD]
- [decisions.md](decisions.md) — architecture choices [updated: 2026-05-20]
- [context.md](context.md) — current focus [updated: 2026-05-07]
- [troubleshooting.md](troubleshooting.md) — known issues [updated: 2026-05-01]

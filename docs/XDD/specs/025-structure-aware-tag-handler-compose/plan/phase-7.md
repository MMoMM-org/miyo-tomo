...
- [ ] **T7.1 WHY docs mirrors** `[activity: documentation]` `[parallel: true]`
...
- [ ] **T7.2 Migrate tsukai handler to output_format** `[activity: config]`
...
- [ ] **T7.3 End-to-end live validation (gated)** `[activity: integration-test]`
...
- [ ] **T7.4 Full-suite + parity regression** `[activity: validate]`

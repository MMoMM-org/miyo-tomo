...
- [x] **T5.1 Squelch read + decrement at moc-discovery start** `[activity: state-management]`
...
- [x] **T5.2 Squelch persist on rejection** `[activity: state-management]`
...
- [x] **T5.3 Phase 5 Validation** `[activity: validate]`

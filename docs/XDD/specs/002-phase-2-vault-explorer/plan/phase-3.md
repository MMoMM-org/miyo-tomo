...
- `docs/XDD/reference/tier-3/wizard/first-session-discovery.md` — /explore-vault 10-step flow
- `docs/XDD/reference/tier-3/lyt-moc/moc-matching.md` — MOC matching algorithm
- `docs/XDD/reference/tier-3/lyt-moc/section-placement.md` — where to place links in MOCs
- `docs/XDD/reference/tier-3/lyt-moc/new-moc-proposal.md` — Mental Squeeze Point detection
- `docs/XDD/reference/tier-3/config/frontmatter-schema.md` — frontmatter detection
- `docs/XDD/reference/tier-3/config/relationship-config.md` — relationship detection
- `docs/XDD/reference/tier-3/config/tag-taxonomy.md` — tag detection
- `docs/XDD/reference/tier-3/config/callout-mapping.md` — callout detection
...
- [ ] **T3.1 Vault Explorer Agent** `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/wizard/first-session-discovery.md]` for the 10-step flow and `[ref: docs/XDD/reference/tier-2/workflows/vault-exploration.md]` for the 7-step workflow
...
- [ ] **T3.3 LYT Patterns Skill** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/lyt-moc/moc-matching.md]`, `[ref: docs/XDD/reference/tier-3/lyt-moc/section-placement.md]`, `[ref: docs/XDD/reference/tier-3/lyt-moc/new-moc-proposal.md]`
...
- [ ] **T3.4 Obsidian Fields Skill** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/config/frontmatter-schema.md]`, `[ref: docs/XDD/reference/tier-3/config/relationship-config.md]`, `[ref: docs/XDD/reference/tier-3/config/callout-mapping.md]`, `[ref: docs/XDD/reference/tier-3/config/tag-taxonomy.md]`

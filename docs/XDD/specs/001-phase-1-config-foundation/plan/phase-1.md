...
- `docs/XDD/reference/tier-2/components/framework-profiles.md` — Profile schema, role, design rules
- `docs/XDD/reference/tier-3/profiles/miyo-profile.md` — MiYo profile details
- `docs/XDD/reference/tier-3/profiles/lyt-profile.md` — LYT profile details
...
- [ ] **T1.1 MiYo Framework Profile** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read MiYo profile spec `[ref: docs/XDD/reference/tier-3/profiles/miyo-profile.md]` and profile schema `[ref: docs/XDD/reference/tier-2/components/framework-profiles.md]`
...
- [ ] **T1.2 LYT Framework Profile** `[parallel: true]` `[activity: data-architecture]`
  ...
  1. Prime: Read LYT profile spec `[ref: docs/XDD/reference/tier-3/profiles/lyt-profile.md]` and profile schema `[ref: docs/XDD/reference/tier-2/components/framework-profiles.md]`

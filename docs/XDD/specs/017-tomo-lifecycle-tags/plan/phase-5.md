...
- [x] **T5.1 `suggestion-parser` MOC-branch dispatch** `[activity: parser-extension]`
...
- [x] **T5.2 `instruction-builder.md` MOC-branch — bundled actions emission** `[activity: agent-prompt-update]`
...
- [x] **T5.3 Squelch persistence integration for un-ticked clusters** `[activity: state-management]`
...
- [x] **T5.4 F-43 T6.2 remaining 5 modes + T6.4 launch-gate regression** `[activity: integration-test]`

...
|-------|-------|
| **Created** | 2026-05-20 |
| **Current Phase** | SDD (draft, awaiting ADR confirmation) |
| **Last Updated** | 2026-05-21 (PRD v1.2 committed `3e2d3a0`; SDD v1.0 draft with 6 pending ADRs) |
...
| solution.md | in_progress | SDD v1.0 draft — 6 ADRs awaiting user sign-off (state-machine module shape, kado_client extensions, state-promoter placement, schema validation, tag-captured rename, migration atomicity) |
| plan/ | pending | Migration phased P1–P5; tasks generated by `/tcs-workflow:xdd-plan` after SDD locks |

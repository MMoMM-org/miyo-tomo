...
- [ ] **T1.1a Hashi handoff: `insert_under_marker` action contract** `[activity: documentation]` `[parallel: true]`
...
- [ ] **T1.1b Kokoro contract note (cross-repo, authoritative)** `[activity: documentation]` `[parallel: true]`
...
- [ ] **T1.2 `tomo/schemas/tag-handler.schema.json` — handler config JSON Schema** `[activity: data-architecture]`
...
- [ ] **T1.3 `tomo/scripts/tag-handler-resolve.py` — deterministic resolver** `[activity: backend-api]`

...
- `docs/specs/tier-3/discovery/moc-indexing.md` — MOC tree building, path + tag discovery, level computation
- `docs/specs/tier-3/vault-exploration/cache-generation.md` — cache YAML assembly, validation, atomic write
- `docs/specs/tier-2/components/discovery-cache.md` — cache schema, staleness policy, degraded operation
...
- [ ] **T2.1 MOC Tree Builder** `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/specs/tier-3/discovery/moc-indexing.md]` and `[ref: docs/specs/tier-3/lyt-moc/moc-matching.md]`
...
- [ ] **T2.2 Cache Builder** `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/specs/tier-3/vault-exploration/cache-generation.md]` and `[ref: docs/specs/tier-2/components/discovery-cache.md]`

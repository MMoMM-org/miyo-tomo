...
- [x] **T2.1 Rename `tag-captured.py` → `mark-captured.py` + rewrite to use `write_frontmatter`** `[activity: refactor]`
...
- [x] **T2.2 `suggestions-render.py` emits `tomo:` block** `[parallel: true]` `[activity: backend-implementation]`
...
- [x] **T2.3 `instruction-render.py` emits `tomo:` block + `source_*` cross-refs** `[parallel: true]` `[activity: backend-implementation]`
...
- [x] **T2.4 `suggestions-reducer.py --moc-proposal-mode` emits `tomo:` block** `[parallel: true]` `[activity: backend-implementation]`
...
- [x] **T2.5 `suggestions-reducer.py --fan-resolve` emits `tomo:` block (XDD 012 extension)** `[parallel: true]` `[activity: backend-implementation]`
...
- [x] **T2.6 Agent prompt updates: `moc-architect.md`, `instruction-builder.md`** `[activity: agent-prompt-update]`

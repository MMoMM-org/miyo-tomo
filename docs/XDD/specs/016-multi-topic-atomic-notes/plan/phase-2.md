...
- [ ] **T2.1 Step 7.5 segmentation + per-thread emission** `[activity: agent-prompt]`
  ...
  5. Success:
     - [ ] multi-thread → N atomics `[ref: PRD/A2]`
     - [ ] single-thread regression intact `[ref: PRD/CON-2]`
     - [ ] >200w gate honoured `[ref: SDD/ADR-3]`
     - [ ] every atomic carries `source_stem` `[ref: PRD/A3]`

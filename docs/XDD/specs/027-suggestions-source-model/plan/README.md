...
- [x] [Phase 2: Two-box decision-block UX](phase-2.md)
- [x] [Phase 3: Audio-peer plumbing & source-set deletion](phase-3.md)
- [x] [Phase 4: Breaking wire rename, schema_version bump & cross-repo handoff](phase-4.md)

...
- [ ] **T3.1 Per-instance update selection** `[activity: backend-api]`
...
- [ ] **T3.2 Container identity (name surfaced in container + Hashi)** `[activity: backend-api]` `[parallel: true]`
...
- [ ] **T3.3 Launcher update-availability check** `[activity: backend-api]`

...
- `docs/XDD/reference/tier-3/inbox/state-tag-lifecycle.md` — state machine, tag format, discovery priority
- `docs/XDD/reference/tier-3/templates/token-vocabulary.md` — token resolution system
- `docs/XDD/reference/tier-3/inbox/suggestions-document.md` — suggestions format for parser
...
- [ ] **T1.1 State Scanner** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/inbox/state-tag-lifecycle.md]`
...
- [ ] **T1.2 Token Renderer** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/XDD/reference/tier-3/templates/token-vocabulary.md]`

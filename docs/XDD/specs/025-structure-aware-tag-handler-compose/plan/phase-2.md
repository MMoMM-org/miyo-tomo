...
- [ ] **T2.1 Section parser** `[activity: backend-logic]` `[parallel: true]`
...
- [ ] **T2.2 Assemble + sanitize + anchor selection** `[activity: backend-logic]`
...
- [ ] **T2.3 Fallback signalling** `[activity: backend-logic]`

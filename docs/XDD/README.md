...
| 016 | [Multi-Topic Atomic Notes](specs/016-multi-topic-atomic-notes/) | PRD completed | OQ1–OQ8 resolved 2026-06-10 (all adopt Lean); SDD next. Branch `feat/f-41-multi-topic-atomic-notes` |

...
- [ ] **T1.1 `kado_client.graph_audit()` wrapper + fixtures** `[activity: integration]` `[parallel: true]`
...
- [ ] **T1.2 `lib/garden_exclusions.py` + config schema** `[activity: domain-modeling]` `[parallel: true]`
...
- [ ] **T1.3 Seed the exclusion config + update-script protection (CON-4)** `[activity: platform]` `[parallel: true]`

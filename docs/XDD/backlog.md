...
| F-43 | MOC-creation skill — proactive MOC propose / create outside inbox | 2026-05-06 Obsidian-power brainstorm | **✅ Done 2026-05-09** | **Status: Implemented** at `docs/XDD/specs/013-moc-creation-skill/` (feat/013-phase-4). Six input modes, squelch lifecycle, Hashi 0.2.0 destination-collision guard. Evolution log: `docs/evolution/2026-05/2026-05-09_F-43-moc-creation-skill.md`. Production launch pending live-vault validation (T6.2). Will supersede F-13 (`/scan-mocs`). |

...
- `docs/specs/tier-3/inbox/inbox-analysis.md` — classification heuristics, InboxItemAnalysis
- `docs/specs/tier-3/inbox/suggestions-document.md` — Pass 1 document format
- `docs/specs/tier-3/inbox/instruction-set-generation.md` — Pass 2 action handlers
- `docs/specs/tier-3/inbox/instruction-set-cleanup.md` — cleanup logic
- `docs/specs/tier-2/workflows/inbox-processing.md` — overall flow
...
- [ ] **T2.1 Inbox Analyst Agent** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/specs/tier-3/inbox/inbox-analysis.md]` and `[ref: docs/specs/tier-2/workflows/inbox-processing.md]`
...
- [ ] **T2.3 Instruction Builder Agent** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/specs/tier-3/inbox/instruction-set-generation.md]`
...
- [ ] **T2.4 Vault Executor Agent** `[parallel: true]` `[activity: build-feature]`
  ...
  1. Prime: Read `[ref: docs/specs/tier-3/inbox/instruction-set-cleanup.md]` and `[ref: docs/specs/tier-3/inbox/state-tag-lifecycle.md]`
